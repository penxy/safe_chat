...
BubbleMsg::BubbleMsg(QWidget *parent) : QWidget(parent)
{
...
void BubbleMsg::setText(QString text, QString time, QSize allSize, BubbleMsg::User_Type userType)
{
    m_msg = text;
    m_userType = userType;
    m_time = time;
...
QSize BubbleMsg::fontRect(QString str)
{
    m_msg = str;
    int minHei = 30;
    int iconWH = 40;
...
QSize BubbleMsg::getRealString(QString src)
{
